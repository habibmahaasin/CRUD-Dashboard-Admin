...
<?php 
    ...
    if($role == 'CEO' || $role == 'Manajer'|| $role == 'Team Produksi' || $role == 'Team Marketing'){ ?>

		<?php
		// include database connection file
		include_once("config.php");
		$kode_kategori = $_GET['kode_kategori'];
		$result = mysqli_query($mysqli, "DELETE FROM kategori WHERE kode_kategori='$kode_kategori'");


		header("Location:daftar-kategori.php?berhasil_delete");
?>
